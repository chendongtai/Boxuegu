...
public class SettingActivity extends AppCompatActivity {
    ...
    private RelativeLayout rl_modify_psw,rl_security_settting,rl_exit_login;
    ...
    private void init(){
        ...
        rl_security_settting = (RelativeLayout) findViewById(R.id.rl_security_settting);
        ...
        //设置密保的点击事件
        rl_security_settting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //跳转到设置密保界面
